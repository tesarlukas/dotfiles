...
awful.spawn.with_shell(
    ...
    'dex --environment Awesome --autostart --search-paths "$XDG_CONFIG_DIRS/autostart:$XDG_CONFIG_HOME/autostart"' -- https://github.com/jceb/dexnaughty
)
--]]
...
globalkeys = mytable.join(
	...
	-- 		client.focus:raise()
	-- 	end
	-- end, { description = "Cycle windows forward", group = "client"}),
	--
	...
	-- maim with xclip, very useful screenshot tool
	-- awful.key({ modkey, "Shift" }, "s", function()
	-- 	awful.spawn.with_shell(
	-- 		"maim -s | tee ~/Pictures/Screenshots/$(date +%s).png | xclip -selection clipboard -t image/png"
	-- 	)
	...
	end, { description = "Clipboar history", group = "utils" }),
...
awful.rules.rules = {
	...
	-- Floating clients.
	{
		...
		properties = { floating = true, placement = awful.placement.center },
	},
	...
	-- { rule = { class = "Alacritty" }, properties = { opacity = 0.95 } },
}
